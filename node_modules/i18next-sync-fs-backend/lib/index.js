...
var Backend = function () {
  ...
  _createClass(Backend, [{
    ...
    value: function read(language, namespace, callback) {
      ...
      var filePath = typeof loadPath === 'function' ? loadPath(language, namespace) : loadPath;
      var filename = this.services.interpolator.interpolate(filePath, { lng: language, ns: namespace });
